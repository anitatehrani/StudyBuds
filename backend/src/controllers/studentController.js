...
exports.getStudent = exports.getAllStudents = void 0;
var Student_1 = require("../models/Student");
var student_service_1 = require("../service/student_service");
...
var getStudent = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, student_service_1.getStudentById)(req.params.id)
            ...
            case 2:
                ...
                res.send(err_2.message || 'Internal server error');
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
